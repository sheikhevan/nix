...
static uint32_t colors[][3] = {
    /*               fg          bg          border    */
    [SchemeNorm] = {0x333333ff, 0xCCCCCCff, 0xCCCCCCff},
    [SchemeSel] = {0xCCCCCCff, 0x333333ff, 0x474747ff},
    [SchemeUrg] = {0, 0, 0xCCCCCCff},
};
...
static const char *const autostart[] = {
    ...
    NULL,
    "wbg",
    "/home/evan/pictures/wallpapers/a_road_going_through_a_desert.jpeg",
    NULL,
    "foot",
    "--server",
    NULL,
...
static const char *menucmd[] = {"wmenu-run", "-f", "Iosevka NF 17", "-N",
                                "333333",    "-n", "CCCCCC",        "-S",
                                "CCCCCC",    "-s", "333333",        NULL};
...
static const Key keys[] = {
    ...
    {0, XKB_KEY_XF86AudioRaiseVolume, spawn,
     SHCMD("wpctl set-volume -l 1.5 @DEFAULT_AUDIO_SINK@ 5%+")},
    ...
    {0, XKB_KEY_XF86MonBrightnessDown, spawn, SHCMD("brightnessctl set 10%-")},
    {MODKEY, XKB_KEY_y, spawn, SHCMD("screenshot-wl")},
